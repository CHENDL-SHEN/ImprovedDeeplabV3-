...
def parse_args():
    ...
    parser.add_argument("--output-img-dir", default="../data/vaihingen/test/images_1024_rgb")
    parser.add_argument("--output-mask-dir", default="../data/vaihingen/test/masks_1024_rgb")
