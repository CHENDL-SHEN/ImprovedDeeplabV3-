...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="/media/ders/Fjmnew/newdataP/test/images")
    parser.add_argument("--mask-dir", default="/media/ders/Fjmnew/newdataP/test/labels")
    parser.add_argument("--output-img-dir", default="/media/ders/Fjmnew/newdataPuse/test/images")
    parser.add_argument("--output-mask-dir", default="/media/ders/Fjmnew/newdataPuse/test/labels")
